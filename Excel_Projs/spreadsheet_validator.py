...
log_file = f'{Path.home()}\\small-projects-python\\Excel_Projs\\logs\\log_file.txt'
logging.basicConfig(filename=log_file, level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')

print('Opening workbook...')
wb = openpyxl.load_workbook(f'{Path.home()}\\small-projects-python\\Excel_Projs\\xlsx_files\\random.xlsx')
